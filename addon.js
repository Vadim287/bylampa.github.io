...
var notice = '<div style="padding: 0.3em 0.3em; padding-top: 0;"><div style="background: #3e3e3e; padding: 0.5em; border-radius: 1em;"><div style="line-height: 1.2;"><span style="color: #f3d900"><div style="text-align: center;">Плагины TMDB Proxy<br> СТАВИМ ТОЛЬКО ПО ОДНОМУ</div></span></div></div></div>';
		...
		Lampa.SettingsApi.addParam({
	     ...
	     Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://bylampa.github.io/tmdb-proxy.js', 'ByLAMPA TMDB Proxy', '@lampa', 'ByLAMPA TMDB', nthChildIndex);
